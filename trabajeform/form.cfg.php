...
"settings":
{
	"data_settings" : 
	{
		...
		"save_sqlite" : 
		{
			"database" : "trabajeform.dat",
			"is_present" : false,
			"tablename" : "trabajeform"
		}
	},
	"email_settings" : 
	{
	...
	"general_settings" : 
	{
		...
		"formname" : "Formulario de Trabaje con Nosotros",
		"is_appstore" : "0",
	...
	"redirect_settings" : 
	{
		...
		"gotopage" : "localhost:8888/trabaje_result.php",
	...
	"uid" : "88fea176f8f8a435c81b095886979828",
	"validation_report" : "in_line"
},
"rules":{"nombre":{"fieldtype":"text","required":true},"email":{"email":true,"fieldtype":"email","required":true},"telefono":{"fieldtype":"text","required":true},"te_necesitamos":{"fieldtype":"textarea","maxlength":"10000","required":true},"innovar":{"fieldtype":"textarea","maxlength":"10000","required":true},"como_lo_harias":{"fieldtype":"textarea","maxlength":"10000","required":true},"por-que":{"fieldtype":"textarea","maxlength":"10000","required":true},"archivo":{"accept":"docx|doc|txt|rtf|pdf","files":true,"attach":true,"database":false,"maxbytes":204800,"fieldtype":"fileupload","label":"Envianos tu CV"}},
"payment_rules":{},
"conditional_rules":{},
