...
<!-- Modal -->
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="mailchimpmodalprg" tabindex="-1" role="dialog" aria-labelledby="mailchimpModal" aria-hidden="true" style="padding-right: 0px !important">
        ...
        <div class="container-fluid">
          <div class="row text-center">
            <div class="col-10 offset-1">
              <h2 class="mb-4">¿Estás interesado en el curso de Programación?</h2>
          ...
          <div id="mc_embed_signup">
            <form action="https://eggtech.us18.list-manage.com/subscribe/post?u=0f9d9776261157d2b356dee5f&amp;id=11731c233c" 
              ...
              <div class="form-group">
              <input placeholder="Nombre Completo" type="text" value="" name="FNAME" class="required form-control" id="mce-FNAME">
            </div>
            <div class="form-group">
          ...
          <div id="mce-responses" class="clearfix" style="width: 100% !important; margin:0 !important; padding:0 !important">
            ...
            <div class="col-md-12 text-center">
              ...
              <input type="submit" value="ENVIAR" name="subscribe"  class="btn btn-primary btn-egg contraste" style="border:none;">
            </div>
          </div>
        </form>
      </div>
