...
<!-- Modal -->
<!-- Modal -->
<div class="modal fade bd-example-modal-lg" id="mailchimpmodal" tabindex="-1" role="dialog" aria-labelledby="mailchimpModal" aria-hidden="true" style="padding-right: 0px !important">
