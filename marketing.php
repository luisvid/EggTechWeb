...
$yourWebsite = "EggTech Marketing"; // the name of your website
      ...
      <div class="container h-100">
        <div class="row h-100 align-items-center">
          <div class="col-10 offset-1 col-md-8 offset-md-2 align-self-center text-center">
            ...
            <a href="download/Egg_Programa_MKT_Digital_2018.pdf" target="_blank" class="btn btn-primary btn-egg btn-lg dark mr-lg-4 mb-3 my-md-3"
      ...
      <div class="container py-5">
        <div class="row py-5">
          <div class="col-12 col-md-8 offset-md-2 text-center py-5">
            ...
            class="btn btn-primary btn-egg contraste d-none d-md-block "><strong>INSCRIBITE AHORA</strong></a> -->
